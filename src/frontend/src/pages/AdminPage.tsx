      ...
      <div className="container max-w-7xl mx-auto px-4 py-8">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="mb-6 flex-wrap h-auto">
            ...
            <TabsTrigger
              value="owner-profile"
              data-ocid="admin.owner-profile.tab"
              className="gap-1.5"
            >
              <User2 className="w-4 h-4" /> মালিকের প্রোফাইল
            </TabsTrigger>
          </TabsList>
...
function OwnerProfileManagement() {
  ...
  const handlePhotoChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file.size > 2 * 1024 * 1024) {
      toast.error("ছবির সাইজ ২ MB-এর বেশি হতে পারবে না");
      return;
    }
    const reader = new FileReader();
    reader.onload = (ev) => {
      ...
      setForm((f) => ({ ...f, profilePhotoBase64: base64 }));
    };
    reader.readAsDataURL(file);
  };
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    update(form);
    setIsSaving(false);
    toast.success("মালিকের প্রোফাইল সংরক্ষিত হয়েছে");
  };
    ...
    <div className="max-w-3xl">
      ...
      <motion.div
        ...
        style={{
          ...
          border: "1px solid oklch(0.30 0.10 255)",
        }}
      >
        <div
        ...
        <div className="flex items-center gap-4 relative z-10">
          <div
            className="w-14 h-14 rounded-2xl flex items-center justify-center flex-shrink-0 overflow-hidden border-2 border-white/20"
          ...
          <div>
            <h2 className="text-white font-bold text-lg">
              {form.name || "মালিকের প্রোফাইল"}
            </h2>
            <p className="text-white/70 text-sm">
              {form.title || "সাইট অ্যাডমিন ও মালিক"}
            </p>
          </div>
          <div className="ml-auto">
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium text-white/90 hover:text-white transition-colors"
              style={{
                background: "oklch(0.40 0.14 255 / 0.4)",
                border: "1px solid oklch(0.55 0.10 255 / 0.4)",
              }}
            >
              <Globe className="w-4 h-4" /> পাবলিক প্রোফাইল দেখুন
            </a>
          </div>
        </div>
      </motion.div>
      ...
      <form onSubmit={handleSave} className="space-y-5">
        ...
        >
          ...
          >
            <Camera className="w-5 h-5" /> প্রোফাইল ছবি
          </h3>
          <div className="flex items-center gap-5">
            <button
              type="button"
              className="w-24 h-24 rounded-2xl overflow-hidden border-2 flex items-center justify-center cursor-pointer hover:opacity-80 transition-opacity"
              style={{
                borderColor: "oklch(0.80 0.08 255)",
            ...
            <div>
              ...
              >
                <Camera className="w-4 h-4" /> ছবি বেছে নিন
              </button>
              <p className="text-xs text-muted-foreground mt-2">
                সর্বোচ্চ ২ MB | JPG, PNG
              </p>
            </div>
            <input
              ref={fileRef}
        ...
        >
          <h3
            ...
            style={{ color: "oklch(0.22 0.08 255)" }}
          >
            <User2 className="w-5 h-5" /> ব্যক্তিগত তথ্য
          </h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              <Label className="text-sm font-medium">পদবি / শিরোনাম</Label>
              <Input
                style={fieldStyle}
                placeholder="যেমন: সাইট অ্যাডমিন ও মালিক"
                value={form.title}
                onChange={(e) =>
            ...
            <div className="space-y-1.5">
              <Label className="text-sm font-medium">হোয়াটসঅ্যাপ নম্বর</Label>
              <Input
                style={fieldStyle}
                placeholder="+880 1XXX-XXXXXX"
                value={form.whatsapp}
            ...
            <div className="sm:col-span-2 space-y-1.5">
              <Label className="text-sm font-medium">পরিচিতি / বায়ো</Label>
              <textarea
                rows={3}
                placeholder="আপনার সম্পর্কে সংক্ষিপ্ত পরিচয়..."
                value={form.bio}
                onChange={(e) =>
        ...
        >
          <h3
            ...
            style={{ color: "oklch(0.22 0.08 255)" }}
          >
            <Award className="w-5 h-5" /> পেশাদার তথ্য
          </h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-1.5">
              <Label className="text-sm font-medium">অভিজ্ঞতা (বছর)</Label>
              <Input
                style={fieldStyle}
            ...
            <div className="space-y-1.5">
              ...
              <Input
                style={fieldStyle}
                placeholder="ব্যবসার লাইসেন্স নম্বর"
        ...
        >
          <h3
            ...
            style={{ color: "oklch(0.22 0.08 255)" }}
          >
            <Globe className="w-5 h-5" /> সোশ্যাল ও ওয়েব লিংক
          </h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-1.5">
              <Label className="text-sm font-medium">ফেসবুক প্রোফাইল / পেজ</Label>
              <Input
                style={fieldStyle}
            ...
            <div className="space-y-1.5">
              <Label className="text-sm font-medium">ওয়েবসাইট</Label>
              <Input
                style={fieldStyle}
                placeholder="https://..."
                value={form.website}
        ...
        >
          ...
          >
            ...
            {isSaving ? "সংরক্ষণ হচ্ছে..." : "প্রোফাইল সংরক্ষণ করুন"}
          </button>
        </motion.div>
      </form>
    </div>
